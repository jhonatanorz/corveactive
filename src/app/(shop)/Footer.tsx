    ...
    <footer className="bg-royal text-ink-on-royal">
      <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="flex gap-3 mt-6">
          {/* Instagram */}
          <a href="https://www.instagram.com/corveactive/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={ICON_LINK}>
          ...
          {/* TikTok */}
          <a href="https://www.tiktok.com/@corveactive" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={ICON_LINK}>
          ...
          {/* WhatsApp (sin enlace por ahora) */}
          <span aria-label="WhatsApp" className={ICON_BASE}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
