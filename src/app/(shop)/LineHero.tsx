...
import { Eyebrow, Isotype } from "@/components/ui";
...
export default function LineHero({ line }: { line: BrowserLine }) {
  return (
    <div className="relative h-[42vh] flex flex-col justify-end p-6 overflow-hidden bg-royal text-ink-on-royal">
      {/* Isotype as the hero centerpiece — soft, bleeding off the corner */}
      <Isotype className="absolute -top-20 -right-20 w-[26rem] h-[26rem] text-periwinkle/40 blur-[2px] rotate-12" />
